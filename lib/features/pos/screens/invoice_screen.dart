...
import 'package:sixvalley_vendor_app/features/pos/screens/invoice_print_screen1.dart';
                          ...
                          child: InkWell(
                            onTap: (){
                              ...
                              _allowPermission().then((access) {
                                ...
                                //     child: InVoicePrintScreen(shopModel: shopController.shopModel,
                                ...
                                //       tax: cartController.totalTaxAmount ?? 0,
                        ...
                        child: Column(children: [
                          ...
                          Column(children: [
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                              ...
                              Text(' - '
                                  '${PriceConverter.convertPrice(context, extraDiscountAmount)}'
