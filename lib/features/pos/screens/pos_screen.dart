...
class _PosScreenState extends State<PosScreen> {
  ...
  void initState() {
    ...
    if(Provider.of<CartController>(context, listen: false).customerSelectedName == ''){
      ...
      Provider.of<CartController>(context, listen: false).setCustomerInfo( 0,  'walking customer', 'NULL', false);
    }
  }
                                        ...
                                        ConfirmPurchaseDialogWidget(
                                            onYesPressed: cartController.isLoading ? null : () {
                                              ...
                                              PlaceOrderBody placeOrderBody = PlaceOrderBody(
                                                ...
                                                cartController.selectedDiscountType == 'percent' ? double.tryParse(PriceConverter.reverseConvertPriceWithoutSymbol(context, extraDiscount)) :
