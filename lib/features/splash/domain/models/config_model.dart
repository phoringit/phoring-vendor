...
class ConfigModel {
  ...
  ConfigModel({
    ...
    this.minimumOrderAmountStatusBySeller;
    this.reviewReplyStatus;
...
class MaintenanceMode {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.selectedMaintenanceSystem != null) {
      data['selected_maintenance_system'] =
          this.selectedMaintenanceSystem!.toJson();
    }
    if (this.maintenanceMessages != null) {
      data['maintenance_messages'] = this.maintenanceMessages!.toJson();
    }
    if (this.maintenanceTypeAndDuration != null) {
      data['maintenance_type_and_duration'] =
          this.maintenanceTypeAndDuration!.toJson();
    }
    return data;
  }
}
...
class SelectedMaintenanceSystem {
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    data['vendor_app'] = this.vendorApp;
...
class MaintenanceTypeAndDuration {
  ...
  MaintenanceTypeAndDuration(
    ...
    if (maintenanceDuration != null) {
      this._maintenanceDuration = maintenanceDuration;
    }
    if (startDate != null) {
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    data['maintenance_duration'] = this._maintenanceDuration;
