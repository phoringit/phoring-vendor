                          ...
                          child: InkWell(
                            onTap: () {
                              if(widget.controller.text.isEmpty) {
                                ...
                                print("====SearchTetx==>>${restockController.searchText}");
                            ...
                            child: Container(
                              ...
                              child: Icon(!restockController.isSearching ? Icons.search : Icons.close, color: Theme.of(context).cardColor, size: 15)
                            ),
                          ),
                        );
                      }
