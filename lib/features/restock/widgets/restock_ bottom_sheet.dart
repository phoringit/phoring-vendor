...
class RestockSheetWidgetState extends State<RestockSheetWidget> {
  ...
  void initState() {
    ...
    print("==restocLimit==>${widget.stockQuantityController?.text}");
    super.initState();
                ...
                return Consumer<AddProductController>(
                  ...
                  return Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                    ...
                    Align(
                        ...
                        child: const Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                          Expanded(
                            child: CustomButtonWidget(
                              backgroundColor: Theme.of(context).colorScheme.error.withOpacity(0.25),
