                  ...
                  child: Column(children: [
                      ...
                      Container(decoration: BoxDecoration(color: Theme.of(context).cardColor,
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
                          Padding(padding: const EdgeInsets.fromLTRB(Dimensions.paddingSizeDefault, Dimensions.paddingSizeMedium, Dimensions.paddingSizeDefault, Dimensions.paddingSizeSmall),
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.center,
      children: [
        ...
        SizedBox(height: 28,
          child: Padding(
            padding:  EdgeInsets.only(left: Provider.of<LocalizationController>(context).isLtr? Dimensions.iconSizeDefault :0,
                right: Provider.of<LocalizationController>(context).isLtr ? 0: Dimensions.iconSizeDefault),
            child: amountValue?
            Text(PriceConverter.convertPrice(context, amount), style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)):
            isLocale?
            Text(getTranslated(title, context)!, maxLines: 1,overflow: TextOverflow.ellipsis,style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)):
            isPercentage?
            Text('$title%', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall), overflow: TextOverflow.ellipsis,maxLines: 1):
